...
![在这里插入图片描述](.\localimages\RabbitMQ\0.png)
...
![在这里插入图片描述](.\localimages\RabbitMQ\1.png)
...
![在这里插入图片描述](.\localimages\RabbitMQ\2.jpg)
...
![在这里插入图片描述](.\localimages\RabbitMQ\3.jpg)
...
![在这里插入图片描述](.\localimages\RabbitMQ\4.jpg)
...
- **如何避免消息重复投递或重复消费**？
  ...
  ![在这里插入图片描述](.\localimages\RabbitMQ\6.png)
...
![在这里插入图片描述](.\localimages\RabbitMQ\5.png)
...
![在这里插入图片描述](.\localimages\RabbitMQ\7.png)

过大的值会导致一个消费者取走了所有消息非常繁忙，其他消费者没有消息可处理空闲等待的现象。

![在这里插入图片描述](.\localimages\RabbitMQ\8.png)
